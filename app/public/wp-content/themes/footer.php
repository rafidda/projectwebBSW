...
// Get ACF options data with Fallbacks (Dummy data) if empty
$footer_about   = function_exists( 'get_field' ) ? ( get_field( 'footer_about', 'option' ) ?: 'Bank Syariah modern yang mengutamakan pelayanan prima dan prinsip keadilan untuk kesejahteraan bersama.' ) : 'Bank Syariah modern yang mengutamakan pelayanan prima dan prinsip keadilan untuk kesejahteraan bersama.';
$phone          = function_exists( 'get_field' ) ? ( get_field( 'phone', 'option' ) ?: '(021) 7401667' ) : '(021) 7401667';
$email          = function_exists( 'get_field' ) ? ( get_field( 'email', 'option' ) ?: 'info@wakalumi.bprs.co.id' ) : 'info@wakalumi.bprs.co.id';
$address        = function_exists( 'get_field' ) ? ( get_field( 'address', 'option' ) ?: 'Jl. Dewi Sartika No.11-A, Ciputat, Kota Tangerang Selatan, Banten 15411' ) : 'Jl. Dewi Sartika No.11-A, Ciputat, Kota Tangerang Selatan, Banten 15411';

// Social links (force true for UI preview if empty)
...
$social_li      = function_exists( 'get_field' ) ? ( get_field( 'social_linkedin', 'option' ) ?: '#' ) : '#';
...
<footer class="bg-slate-900 dark:bg-dark-surface border-t border-slate-800 dark:border-dark-border relative overflow-hidden">
    ...
    <div class="container-wide relative z-10">
        ...
        <div class="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo esc_url( $social_li ); ?>" target="_blank" rel="noopener"
                       class="w-10 h-10 rounded-full bg-slate-800 hover:bg-primary-600 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 dark:bg-dark-surface-alt dark:hover:bg-primary-500 hover:-translate-y-1">
            ...
            <div>
                ...
                <ul class="space-y-4 mb-8">
                    <li class="flex items-start gap-4">
                        ...
                        <span class="text-sm text-slate-400 leading-relaxed"><?php echo esc_html( $address ); ?></span>
                    </li>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center justify-between text-sm border-b border-slate-800 pb-2">
                        ...
                        <span class="text-primary-400 font-medium">09:00 - 15:00 WIB</span>
                    </li>
                    <li class="flex items-center justify-between text-sm border-b border-slate-800 pb-2">
                        <span class="text-slate-400">Sabtu, Minggu &amp; Libur</span>
                        <span class="text-rose-400 font-medium">Tutup</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="maps-wrapper rounded-2xl overflow-hidden mb-6 border border-slate-700/50 dark:border-dark-border w-full flex-grow shadow-lg" style="min-height: 200px;">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.5!2d106.74!3d-6.34!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMjAnMjQuMCJTIDEwNsKwNDQnMjQuMCJF!5e0!3m2!1sen!2sid!4v1" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
        ...
        <!-- Bottom Bar -->
        <div class="py-6 border-t border-slate-800 dark:border-dark-border flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            <p class="text-xs font-medium text-slate-500">
                &copy; <?php echo date( 'Y' ); ?> Bank Syariah Wakalumi. All Rights Reserved.
            </p>
            <p class="text-xs text-slate-400 md:max-w-xl md:text-right leading-relaxed">
                BPRS Wakalumi Berizin dan Diawasi Oleh Otoritas Jasa Keuangan (OJK) serta merupakan peserta program penjaminan Lembaga Penjamin Simpanan (LPS).
            </p>
        </div>
    </div>
</footer>
